#!/usr/bin/python3
"""Script for training the MobileVOD with 3 LSTM layers. As in mobilenet, here we use depthwise seperable convolutions 
...
if __name__ == '__main__':
	...
	for epoch in range(last_epoch + 1, args.num_epochs):
		...
		if epoch % args.validation_epochs == 0 or epoch == args.num_epochs - 1:
			...
			model_path = os.path.join(args.checkpoint_folder, f"lstm3-wm-{args.width_mult}/Epoch-{epoch}-Loss-{val_loss}.pth")
